...
Go to admin/config/development/maintenance and put your site in maintenance mode.
This will prevent anyone from commenting on a node while the comment tree is being built
